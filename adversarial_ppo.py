...
if os_name == 'Windows':
    env_name = r"C:\Users\power\OneDrive\바탕 화면\진로탐색(1)\ML-Agents_Project\Env\Pong\Pong.exe"  # 경로 수정
elif os_name == 'Darwin':
    env_name = f"../Env/{game}_{os_name}"

# 모델 저장 및 불러오기 경로
date_time = datetime.datetime.now().strftime("%Y%m%d%H%M%S")
save_path = r"C:\Users\power\OneDrive\바탕 화면\진로탐색(1)\ML-Agents_Project\Pong_ppo\saved_models\APPO" + f"\\20221004220009"  # 경로 수정
load_path = r"C:\Users\power\OneDrive\바탕 화면\진로탐색(1)\ML-Agents_Project\Pong_ppo\saved_models\APPO" + f"\\20221004220009"  # 경로 수정
